...
class Paper:
    ...
    def parse_pdf(self):
        ...
        self.all_text: str = ' '.join(self.text_list)
        self.section_page_dict = self._get_all_sections_index()  # section与page的对应字典
        
        pprint.pprint(self.section_page_dict)
    ...
    def get_title(self):
        ...
        max_font_sizes = [0]
        for page_index, page in enumerate(doc):  # note 遍历前10页
    ...
    def _get_all_sections_index(self):
        # 定义需要寻找的章节名称列表
        ...
        for page_index, page in enumerate(self.pdf):
            ...
            for section_name in section_list:
                ...
                if "Abstract" == section_name and section_name in cur_text:
                    ...
                    section_page_dict["Abstract"] = page_index
